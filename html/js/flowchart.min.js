...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        options: {
            ...
            defaultLinkColor: '#aebd54',
            defaultSelectedLinkColor: '#5d6629',
            linkWidth: 10,
            grid: 20,
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            var tiene_info = '';
            if(infos.hasOwnProperty('miinfo'))
            {
                tiene_info  = infos.miinfo;
            }
            
            var $operator = $('<div class="flowchart-operator" info="'+tiene_info+'"></div>');
