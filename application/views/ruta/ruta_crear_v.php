...
<div class="ruta-dinamica">
	...
	<div class="ruta_elementos">
		<div class="ruta_elementos_label">
			...
			<form action="/ruta/ruta_dinamica/almacenar" method="post" id="ruta_form">
				...
				<table>
					<tr style="display: none;">
						<th>Ruta:</th>
						<td>
							<input type="text" name="ruta_nombre" size="45" />
						</td>
					</tr>
					<tr>
						<th>Elemento:</th>
...
?>
		...
		<div class="ruta_elementos_divs">
			<div class="ruta_departamento" info="2">Arte</div>
			<div class="ruta_departamento" info="5">PrePrensa</div>
			<div class="ruta_departamento" info="28">Supervisi&oacute;n</div>
			<div class="ruta_departamento" info="9">Planchas</div>
			<div class="ruta_departamento" info="15">Administraci&oacute;n</div>
			<div class="ruta_departamento" info="10">Despacho</div>
		</div>
	...
	<div class="ruta_elementos">
		<div class="ruta_elementos_label derecha">
			<input type="button" value="Guardar Ruta" id="ruta_guardar" />
		</div>
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		function getOperatorData($element)
		{
			...
			Leyenda = $element.text();
			//Leyenda = Leyenda.substring(0, 9) + '.';
			data.properties.inputs['input'] ={ label: Leyenda };
